...
public class AddTruckActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayAdapter<CharSequence> adapter = ArrayAdapter.createFromResource(this,
                R.array.variants_array_trucks, android.R.layout.simple_spinner_item);
        ...
        loadingDateTextView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatePickerDialog datePickerDialog = new DatePickerDialog(AddTruckActivity.this,
                ...
                datePickerDialog.getButton(DialogInterface.BUTTON_POSITIVE).setTextColor(ContextCompat.getColor(AddTruckActivity.this, R.color.dark_green)); // Change this to your desired color
                datePickerDialog.getButton(DialogInterface.BUTTON_NEGATIVE).setTextColor(ContextCompat.getColor(AddTruckActivity.this, R.color.dark_green)); // Change this to your desired color
            }
        });
        ...
        loadingLocationTextView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Dialog dialog = new Dialog(AddTruckActivity.this);
                ...
                MyLocationNewOverlay myLocationOverlay = new MyLocationNewOverlay(new GpsMyLocationProvider(AddTruckActivity.this), map);
                ...
                MapEventsReceiver mapEventsReceiver = new MapEventsReceiver() {
                    ...
                    public boolean singleTapConfirmedHelper(GeoPoint p) {
                        ...
                        Geocoder geocoder = new Geocoder(AddTruckActivity.this, Locale.getDefault());
        ...
        postButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String bodyType = ((Spinner) findViewById(R.id.spinner)).getSelectedItem().toString();
                ...
                String truckId = databaseReference.child("users").child(userId).child("trucks").push().getKey();
                Truck truck = new Truck();
                truck.setId(truckId);
                truck.setUserId(userId);
                truck.setImageUrl(imageUrl);
                truck.setTitle(title);
                truck.setDescription(description);
                truck.setBodyType(bodyType);
                truck.setVolume(volume);
                truck.setWeight(weight);
                truck.setUnit(selectedUnit);
                truck.setDate(loadingDateTextView.getText().toString());
                truck.setUnloadingDate(unLoadingDateTextView.getText().toString());
                truck.setLoadingLocation(selectedLoadingLocation.getLatitude() + "," + selectedLoadingLocation.getLongitude());
                truck.setUnloadingLocation(selectedUnloadingLocation.getLatitude() + "," + selectedUnloadingLocation.getLongitude());
                truck.setPrice(price);

                // Write Post object to Firebase database under the current user's node
                databaseReference.child("users").child(userId).child("trucks").child(truckId).setValue(truck)
                        .addOnSuccessListener(new OnSuccessListener<Void>() {
                            @Override
                            public void onSuccess(Void aVoid) {
                                Toast.makeText(AddTruckActivity.this, "Truck added", Toast.LENGTH_SHORT).show();
                                Log.d("AddTruckactivity", "Truck added successfully"); // Log success
                        ...
                        .addOnFailureListener(new OnFailureListener() {
                            ...
                            public void onFailure(@NonNull Exception e) {
                                Toast.makeText(AddTruckActivity.this, "Failed to add truck", Toast.LENGTH_SHORT).show();
                                Log.e("AddTruckActivity", "Failed to add truck", e); // Log failure
            ...
            if (resultUri != null) {
                ...
                uploadTask.addOnFailureListener(new OnFailureListener() {
                    ...
                    public void onFailure(@NonNull Exception exception) {
                        ...
                        Toast.makeText(AddTruckActivity.this, "Failed to upload image", Toast.LENGTH_SHORT).show();
                    }
                    ...
                    public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                        ...
                        imageRef.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                            ...
                            public void onSuccess(Uri downloadUri) {
                                ...
                                Toast.makeText(AddTruckActivity.this, "Image uploaded successfully", Toast.LENGTH_SHORT).show();
                            }
                        });
                    }
                });
